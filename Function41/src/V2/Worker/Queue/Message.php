...
namespace Neighborhoods\KojoFitnessFunction41\V2\Worker\Queue;

use Neighborhoods\KojoFitnessFunction41\V2\Guzzle;
use Neighborhoods\KojoFitnessFunction41\V2\Aws;
...
class Message implements MessageInterface
{
    ...
    public function delete() : MessageInterface
    {
        ...
        $this->getV2AwsSqsSqsClient()->deleteMessage(
            [
