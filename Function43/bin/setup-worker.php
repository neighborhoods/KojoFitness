...
$jobCreator->setCode(Neighborhoods\KojoFitnessFunction43\V1\Worker::JOB_TYPE_CODE)
    ->setWorkerClassUri(\Neighborhoods\KojoFitnessFunction43\V1\Worker\Facade::class)
