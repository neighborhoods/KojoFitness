...
docker-compose exec kojo_fitness bash -c 'cd UseCase51; rm -f composer.lock; composer install';
docker-compose exec kojo_fitness bash -c 'cd UseCase51; ./vendor/bin/kojo db:setup:install $PWD/src/V1/Environment/';
docker-compose exec kojo_fitness bash -c 'cd UseCase51; php ./bin/create-userspace-table.php; php ./bin/setup-workers.php; php ./bin/schedule-producer-job.php';
...
docker-compose exec kojo_fitness bash -c 'cd UseCase51; ./vendor/bin/kojo db:tear_down:uninstall $PWD/src/V1/Environment/';
