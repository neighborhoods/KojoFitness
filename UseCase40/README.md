# Defines the fitness of Kōjō for
 ...
 docker-compose exec kojo_fitness bash -c 'cd UseCase40; php ./bin/create-messages.php';
 ...
 docker-compose exec kojo_fitness bash -c 'cd UseCase40; ./vendor/bin/kojo db:tear_down:uninstall $PWD/src/V1/Environment/';
