...
$producerJobCreator
    ...
    ->setWorkerClassUri(\Neighborhoods\KojoFitnessUseCase52\V1\Producer\Facade::class)
...
$consumerJobCreator
    ...
    ->setWorkerClassUri(\Neighborhoods\KojoFitnessUseCase52\V1\Consumer\Facade::class)
    ->setWorkerMethod('start')
