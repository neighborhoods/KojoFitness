...
$jobCreator->setCode(Neighborhoods\KojoFitnessFunction45\V1\Worker::JOB_TYPE_CODE)
    ->setWorkerClassUri(Neighborhoods\KojoFitnessFunction45\V1\Worker\Facade::class)
